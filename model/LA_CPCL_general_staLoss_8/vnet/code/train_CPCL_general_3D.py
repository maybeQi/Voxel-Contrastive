...
parser.add_argument('--exp', type=str,
                    default='LA_CPCL_general_staLoss', help='experiment_name--自定义stable_loss') # _staLoss: --stability_loss 1
parser.add_argument('--model', type=str,
                    default='vnet', help='model_name')
parser.add_argument('--max_iterations', type=int,
                    default=3336, help='maximum epoch number to train--起初为10000')
...
def getPrototype(features, mask, class_confidence):
    ...
    mask_new = mask.unsqueeze(1)  # bs x 1 x Z x H x W，batchsize x C x Z x x H x W
