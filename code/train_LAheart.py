...
parser.add_argument('--exp', type=str,default='LA_My_0.1_7/16_',
                    help='experiment_name')  # _staLoss: --stability_loss 1
parser.add_argument('--model', type=str,
                    default='vnet', help='model_name')
parser.add_argument('--max_iterations', type=int,
                    default=4000, help='maximum epoch number to train--起初为4000')
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss = supervised_loss + consistency_weight *(ct_loss+L2U_consistency_loss+MT_stability_loss)
